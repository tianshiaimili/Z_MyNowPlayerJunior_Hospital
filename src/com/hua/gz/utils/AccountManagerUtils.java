...
public class AccountManagerUtils {
	...
	private static final String TAG = AccountManagerUtils.class.getSimpleName();
	 ...
	 */
	public AccountManagerUtils(Context context, String accountsType, String authTokenType, Activity caller) {
		mContext = context;
	 ...
	 * @param caller the caller of AccountManagerHelper.
	 */
	public AccountManagerUtils(Context context, String accountsType, String authTokenType, Fragment caller) {
		mContext = context;
		mAccountsType = accountsType;
		mAuthTokenType = authTokenType;
		mAccountManagerCallback = new InnerAccountManagerCallback(caller);
