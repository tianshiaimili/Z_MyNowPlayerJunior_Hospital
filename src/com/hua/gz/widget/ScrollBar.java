...
public class ScrollBar {
	...
	public interface ScrollBarItemInfoProvider {
		 ...
		 * @param value
		 */
		public void setItemContent(ScrollBar builder, View convertView, Object value);
	...
	public interface OnScrollBarItemClickListener {
		 ...
		 * @param text
		 */
		public void onClick(ScrollBar bar, View convertView, int position);
	}
    ...
    public static class Builder {
    	...
    	public Builder setItemResId(int itemResId) {
    	 ...
    	 */
    	public ScrollBar create(final HorizontalScrollView hsv) {
            ...
            for(int i=0; i<mScrollBar.count; i++) {
    			...
    			final View t = inflater.inflate(mItemResId, layout, false);
    			mScrollBar.viewList.add(t);
    			mScrollBarItemInfoProvider.setItemContent(mScrollBar, t, mScrollBar.dataList.get(i));
