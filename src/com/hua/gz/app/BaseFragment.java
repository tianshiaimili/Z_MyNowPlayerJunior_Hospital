...
public class BaseFragment extends Fragment implements AppLocaleAideSupport {
	...
	public void onAttach(Activity activity) {
		...
		Log.d(TAG, getTag() + " onAttach() : " + getActivity());
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// only after onCreateView() can getView(). Even after super.onCreateView(), getView() still null.
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		Log.i(TAG, getTag() + " onActivityCreated(), isFragmentRecreatedWithHoldView() " + isFragmentRecreatedWithHoldView());
	...
	public void onDestroyView() {
		// boolean before = getView() == null; // false
		super.onDestroyView();
		// boolean after = getView() == null; // false
		...
		Log.i(TAG, getTag() + " onDestroyView()");
	...
	public void onDetach() {
		...
		mFragmentView = null;
		Log.d(TAG, getTag() + " onDetach() : " + getActivity());
	}
    ...
    private boolean isHostActivityNull() {
		if(getActivity() == null) {
			Log.e(TAG, this.getClass().getSimpleName() + ".getActivity() returns null");
			return true;
		}
		return false;
    }
    ...
    private boolean isFragmentViewNull() {
		if(getView() == null) {
			Log.e(TAG, this.getClass().getSimpleName() + ".getView() returns null");
			return true;
		}
		return false;
    }
	...
	public void toast(String text, boolean shortDuration) {
		Toast.makeText(getActivity(), text, shortDuration ? Toast.LENGTH_SHORT : Toast.LENGTH_LONG).show();
	}
	
	public void toast(int textResId, boolean shortDuration) {
		Toast.makeText(getActivity(), getResources().getString(textResId), shortDuration ? Toast.LENGTH_SHORT : Toast.LENGTH_LONG).show();
	}
