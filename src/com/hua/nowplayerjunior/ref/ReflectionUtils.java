package com.hua.nowplayerjunior.ref;
...
public class ReflectionUtils {
	 ...
	 * Note:
	 * 
	 * 1.important class in package java.lang.reflect:
	 * 
	 * Class
	 * Field
	 * Method
	 ...
	 * 2. performance:
	 * 
	 * The lookup(find class, find method, find field) is expensive than the regular way(new class()):
	 * it depends on JVM and device, it may range from several times(find method, find field) 
	 * to hundreds of times(find class) slower than regular way nowadays(2012-09, JDK6update20, Intel core i7).
	 * 
	 * The invocation(method.invoke()) is relatively cheap than the regular way(class.method()):
	 * around almost the same to several timers slower than regular way.
	 */
